...
if(isset($_POST['tweet'])){
    ...
    if(strlen($status)>140){
    	$error="Your tweet should be less than 140 characters";
    ...
    if(!empty($hashtag)){
		...
		$error="Insert status or image to display";
		...
		<div class="info-box">
			<div class="info-inner">
				...
				<div class="info-in-body">
					...
					<div class="info-body-name">
						<div class="in-b-name">
							...
							<span><small><a href="profile.php?username=<?php echo $user->username;?>">@<?php echo $user->username;?></a></small></span>
						</div><!-- in b name end-->
				...
				<div class="info-in-footer">
					...
					<a class "edit" href="profileEdith.php">Edit info</a>
				</div><!-- info in footer -->
			</div><!-- info inner end -->
		</div><!-- info box end-->
...
$getFromT->tweets($user_id);
				...
				<!--Tweet END WRAPER-->
 			<script type="text/javascript" src="assets/js/likes.js">
